...
from app.core.config import get_sandbox_max_concurrency


_sandbox_slots = threading.BoundedSemaphore(get_sandbox_max_concurrency())
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    raise SandboxError(
                        "Docker sandbox status could not be read"
                    ) from exc
            ...
            try:
                ...
                raise SandboxError(
                    "Docker sandbox result could not be read"
                ) from exc
